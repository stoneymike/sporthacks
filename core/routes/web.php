...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::post('advertise/store', 'AdvertiseController@store')->name('advertise.store');
        Route::post('advertise/update/{id}', 'AdvertiseController@update')->name('advertise.update');
        Route::post('advertise/delete/{id}', 'AdvertiseController@delete')->name('advertise.delete');
        Route::post('advertise/status/{advertise}', 'AdvertiseController@status')->name('advertise.status');
...
Route::get('news/{id}/{slug?}', 'SiteController@newsDetails')->name('news.details');
Route::get('category/{id}/{slug}', 'SiteController@categoryDetails')->name('category.details');
Route::post('load-more', 'SiteController@loadMore')->name('load.more');

Route::get('videos', 'SiteController@videos')->name('videos');
Route::get('photos', 'SiteController@photos')->name('photos');
Route::get('search', 'SiteController@search')->name('search');

Route::get('archive/{date}', 'SiteController@archived')->name('archive');
