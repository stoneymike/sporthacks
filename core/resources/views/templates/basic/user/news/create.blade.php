            ...
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="row addVideo">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="title" required placeholder="@lang('News Title')">
                                </div>
                        ...
                        <div class="col-md-12">
                            <button class="btn btn--primary w-100">@lang('Create News')</button>
                        </div>
                    </div>
                </form>
            </div>
...
@push('breadcrumb-plugins')
    <a href="{{ url()->previous() == url()->current() ? route('user.news.index') :  url()->previous()}}" class="btn btn--primary float-sm-right ml-lg-3 mb-3 text-white"> <i
