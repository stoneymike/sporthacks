                                ...
                                <form method="post" action="{{ route('ticket.reply', $my_ticket->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <button type="submit" class="btn btn--base custom-success mt-4">
            ...
            $('.addFile').on('click',function(){
                $("#fileUploadsContainer").append(
                    `<div class="input-group">
                        <input type="file" name="attachments[]" class="form-control my-4" required />
                            <span class="input-group-text btn btn-danger support-btn remove-btn m-4">x</span>
                    </div>`
                )
            });
