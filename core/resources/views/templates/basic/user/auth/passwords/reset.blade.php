            ...
            <div class="form-wrapper">
                ...
                <form action="{{ route('user.password.update') }}" method="POST" class="cmn-form mt-30">
                    ...
                    <div class="form-group hover-input-popup">
                        ...
                        <input id="password" type="password" class="form-control b-radius--capsule @error('password') is-invalid @enderror" name="password" required>
                    ...
                    <div class="form-group">
                        ...
                        <input id="password-confirm" type="password" class="form-control b-radius--capsule" name="password_confirmation" required>
                        <i class="las la-lock input-icon"></i>
                    </div>
