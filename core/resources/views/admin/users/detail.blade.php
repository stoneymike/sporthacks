            ...
            <div class="row mb-none-30">
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--deep-purple b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.user.news.index',$user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="fa fa-newspaper"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ $user->news_count }}</span>
                            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--orange b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.user.news.pending',$user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="fa fa-spinner"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ $pendingNews }}</span>
                            </div>
                            <div class="desciption">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--success b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.user.news.approved',$user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-check-circle"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ $approvedNews }}</span>
                            </div>
                            <div class="desciption">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--danger b-radius--10 box-shadow has--link">
                        <a href="{{route('admin.user.news.rejected',$user->id)}}" class="item--link"></a>
                        <div class="icon">
                            <i class="la la-times-circle"></i>
                        </div>
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{ $rejectedNews }}</span>
                            </div>
                            <div class="desciption">
