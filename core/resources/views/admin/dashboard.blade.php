            ...
            <div class="dashboard-w1 bg--primary b-radius--10 box-shadow">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span class="text--small">@lang('Total Staffs')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--cyan b-radius--10 box-shadow">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span class="text--small">@lang('Total Verified Staffs')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--orange b-radius--10 box-shadow ">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span class="text--small">@lang('Total Email Unverified Staffs')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span class="text--small">@lang('Total SMS Unverified Staffs')</span>
                    </div>
